...
/**
 * Interface for elements that can be rendered on the window.
 */
public interface Elements {
	
	/**
	 * Renders the element based on the provided window size and modification flags.
	 *
	 ...
	 */
	Parent render(int width, int height, boolean redrawAll);
}
