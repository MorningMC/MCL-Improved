package morningmc.foliage.minecraft.cilent.libraries;

import morningmc.foliage.minecraft.cilent.MinecraftDirectory;
import morningmc.foliage.util.ChecksumUtils;
...
public class Asset implements Serializable {
    ...
    public boolean isValid(MinecraftDirectory dir) throws IOException, NoSuchAlgorithmException {
        return ChecksumUtils.verify(dir.getAssetFile(this), getHash(), "SHA-1", size);
    }
